...
const columns: readonly Column[] = [
    ...
    { id: 'edad', label: 'Edad', minWidth: 170, align: 'right' },
    { id: 'fichaMedica', label: 'Ficha Medica', minWidth: 170, align: 'right' },
    // Agrega los demás campos del paciente aquí
  ];
...
const Pacientes = () => {
  ...
  const { obtenerPaciente } = useDashboardStore();
